...
public class ScriptNewTableRowInsert implements IJDomScript {
	...
	public Object execute(Document document, String methodName, String docIdentifier) {
		...
		try {
			System.out.println("*************  Inside ScriptNewTableRowInsert scripts.");

			System.out.println("*************  Start execution of the ScriptNewTableRowInsert scripts.");
			...
			// writeToXML(document);
			System.out.println("*************  End execution of the ScriptNewTableRowInsert scripts.");
		} catch (Exception e) {
